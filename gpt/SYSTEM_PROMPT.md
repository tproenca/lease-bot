...
3. Para cada `placeholders.added`:
   ...
   b. Se Texto: "É obrigatório?" + "É derivado?" (sim: "Fórmula?" — derived_from=1º campo; não: "Valor padrão?")
              + "Qual transformação?" (1.Maiúsculas 2.Minúsculas 3.Título 4.Frase)
              + "Deseja restringir valores?" → se sim, colete `options`
   c. Se Data: "É obrigatório?" + "É derivado?" (sim: "Fórmula?" — derived_from=1º campo; não: "Valor padrão?") + "Qual formato de data?" (1.Normal 2.Por extenso)
   d. Se CPF: "É obrigatório?" apenas
   e. Se Inteiro: "É obrigatório?" + "É derivado?" (sim: "Fórmula?" — derived_from=1º campo; não: "Valor padrão?")
